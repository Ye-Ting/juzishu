  ...
  <form method='post' id='ajaxForm'>
    <table class='table table-form'>
      ...
      <tr>
        ...
        <td class='w-p40'>
        <?php 
        echo html::select("categories[]", $categories, array_keys($article->categories), "disabled class='form-control chosen'");
        ?>
        </td><td></td>
      </tr>
      <?php echo html::hidden("categories[]", $article->categories);?>
      <!-- <tr>
      ...
      <tr>
        ...
        <td>
          <div id='copyBox' class='row' style="display:none">
