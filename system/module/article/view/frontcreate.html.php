    ...
    <form method='post' role='form' id='ajaxForm'>
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td class='w-p40'><?php echo html::select("categories[]", $categories, $currentCategory, " disabled class='form-control chosen'");?>
          </td><td></td>
        </tr>
        <?php echo html::hidden("categories[]", $currentCategory);?>
        <!-- <tr>
          <th><?php echo $lang->article->author;?></th>
          <td><?php echo html::input('author', $app->user->realname, "class='form-control'");?></td>
        </tr> -->
        <?php echo html::hidden('author', $app->user->realname, "class='form-control'");?>
        <tr>
          ...
          <td>
            <div class='row' id='copyBox' style="display:none">
