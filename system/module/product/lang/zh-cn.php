...
$lang->product->list       = '活动列表';
$lang->product->hot        = '热门活动';
$lang->product->admin      = '维护活动';
$lang->product->create     = '发布活动';
$lang->product->edit       = '编辑活动';
$lang->product->files      = '附件';

$lang->product->confirmDelete = '您确定删除该活动吗？';
